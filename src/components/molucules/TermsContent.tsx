...
export const TermsContent: FC = memo(() => {
  return (
    <>
      ...
      <PrimaryText title="第3条（本サービスの提供の停止等）">
        <p>
      ...
      <PrimaryText title="第5条（保証の否認および免責事項）">
        <p>
